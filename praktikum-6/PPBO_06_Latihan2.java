...
public class PPBO_06_Latihan2 {
    public static void main(String[] args) {
        ...
        for(Map.Entry<String, Mahasiswa> data : mahasiswaHashMap.entrySet()){
            System.out.println("key: " + data.getKey()+" => data mahasiswa: " + 
            data.getValue().nama + " , " + data.getValue().NIM + " , " + data.getValue().angkatan);
        }
